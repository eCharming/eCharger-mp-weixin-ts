  ...
  <view style="display: flex;flex-direction:column">
    ...
    <add-card>
      <view style='width:100%' class='display'>
        ...
        <view class="problem">提示条款:
        </view>
        <view class="problem">
          提醒您：在使用易插各项服务前，请您务必仔细阅读并透彻理解本声明。如对本声明内容有任何疑问，您可向平台客服咨询。阅读本声明的过程中，如果您不同意本声明或其中任何内容，您应立即停止使用平台服务。如果您使用平台服务的，即意味着您认可本声明全部内容。
        </view>
        <view class="problem">定义:
        </view>
        <view class="problem">平台：指包括但不限于客户端。
        </view>
        <view class="problem">易插：平台经营者的单称或合称，包括但不限于集团旗下子公司、分公司及关联公司等。
        </view>
        <view class="answer">权利声明

        </view>
        <view class="problem">一、权利归属
        ...
        <view class="problem">三、责任限制 平台对其自行上传的内容在法律框架内承担责任；平台对用户自行发表的言论、商品信息等，不承担任何责任。
        ...
        <view class="answer">一、适用范围
        </view>
        <view class="problem">本隐私权政策适用于平台提供的所有服务，您访问平台网站及/或登陆相关客户端使用平台提供的服务，均适用本隐私权政策。
          需要特别说明的是，本隐私权政策不适用于其他第三方向您提供的服务，例如上的卖家依托平台向您提供服务时，您向卖家提供的个人信息不适用于本隐私权政策。

        </view>
        <view class="answer">二、我们如何收集信息
        </view>
        <view class="problem">我们收集信息是为了向您提供优质、个性化的服务，我们收集信息的方式如下：
        </view>
        <view class="problem">1.您向我们提供的信息。
          当您注册账户及您在使用平台时提供的相关服务时填写及或提交的信息，包括您的姓名、性别、出生年月日、身份证号码、护照姓名、护照号码、电话号码、电子邮箱、地址、邮编、银行账号及相关附加信息。
        </view>
        <view class="problem">2.在您使用服务过程中收集的信息。 为了提供并优化您需要的服务，我们会收集您使用服务的相关信息，这类信息包括：
        ...
        <view class="problem">3.来自第三方的信息
        </view>
        <view class="problem">为了给您提供更好、更优、更加个性化的服务，或共同为您提供服务，或为了预防互联网欺诈的目的，的关联方、合作伙伴会依据法律的规定或与您的约定或征得您同意的前提下，向分享您的个人信息。
          您了解并同意，以下信息不适用本隐私权政策：
        </view>
        <view class="problem">a）您在平台进行交易的有关数据，包括但不限于出价、成交信息及评价等数据；
        </view>
        <view class="problem">b）您在使用平台提供的搜索服务时输入的关键字信息；
        </view>
        <view class="problem">c）信用评价、违反法律规定或违反规则行为及已对您采取的措施；
        </view>
        <view class="problem">d) 应法律法规要求需公示的企业名称等相关工商注册信息以及自然人经营者的信息。

        </view>
        <view class="answer">三、我们如何使用信息
        </view>
        <view class="problem">收集您的信息是为了向您提供优质、个性化服务的目的，为了实现该目的，我们会把您的信息用于下列用途：
        </view>
        <view class="problem">1.向您提供您使用的各项服务，并维护、改进这些服务。
        </view>
        <view class="problem">
          2.向您推荐您可能感兴趣的内容，包括但不限于通过系统向您展示个性化的推广信息，向您发出产品和服务信息，或者在征得您同意的情况下与的合作伙伴共享信息以便他们向您发送有关其产品和服务的信息。如您不希望接收上述信息，可通过相应的退订功能进行退订。
        </view>
        <view class="problem">3.我们可能使用您的个人信息以预防、发现、调查欺诈、危害安全、非法或违反与我们或其关联方协议、政策或规则的行为，以保护您、其他我们用户，或我们或其关联方的合法权益。
        </view>
        <view class="problem">4.我们可能会将来自某项服务的个人信息与来自其他服务的信息结合起来，用于为了给您提供更加个性化的服务使用，例如让您拥有更广泛的社交圈的需要而使用、共享或披露。
        </view>
        <view class="problem">5.经您许可的其他用途。

        </view>
        <view class="answer">四、我们如何共享信息
        </view>
        <view class="problem">我们对您的信息承担保密义务，不会为满足第三方的营销目的而向其出售或出租您的任何信息，我们会在下列情况下才将您的信息与第三方共享：
        </view>
        <view class="problem">1.事先获得您的同意或授权。
        </view>
        <view class="problem">2.根据法律法规的规定或行政或司法机构的要求。
        </view>
        <view class="problem">3.向关联方分享您的个人信息。
        </view>
        <view class="problem">4.向可信赖的合作伙伴提供您的个人信息，让他们根据我们的指示并遵循我们的隐私权政策以及其他任何相应的保密和安全措施来为我们处理这些信息。
        </view>
        <view class="problem">5.如您出现违反中国有关法律、法规或者相关协议或相关规则的情况，需要向第三方披露。
        </view>
        <view class="problem">6.为维护及其关联方或用户的合法权益。

        </view>
        <view class="answer">五、Cookie 和网络 Beacon 的使用
        </view>
        <view class="problem">为使您获得更轻松的访问体验，您访问平台相关网站或使用平台提供的服务时，我们可能会通过Cookie，Flash
        ...
        <view class="answer">六、信息存储
        </view>
        <view class="problem">收集的有关您的信息和资料将保存在及（或）其关联公司的服务器上，这些信息和资料可能传送至您所在国家、地区或收集信息和资料所在地并在该地被访问、存储和展示。

        </view>
        <view class="answer">七、您的个人信息保护
        </view>
        <view class="problem">
